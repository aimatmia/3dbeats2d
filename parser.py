...
def parse_file( fname, edges, transform, screen, color ):
    ...
    while c < len(lines):
        ...
        if line == 'line':
            ...
            generate_sphere(edges, int(args[0]), int(args[1]), int(args[2]), int(args[3]), 0.05)
       elif line == 'torus':
            #add_torus
            generate_torus(edges, int(args[0]), int(args[1]), int(args[2]), int(args[3]), int(args[4]), 0.05)
